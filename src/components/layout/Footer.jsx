...
const BuildingIllustration = () => (
  <svg viewBox="0 0 260 200" xmlns="http://www.w3.org/2000/svg" className="footer-building-svg">
    <defs>
    ...
    {[[20,18],[55,12],[90,22],[130,8],[170,15],[210,10],[240,20],[15,40],[245,38]].map(([x,y],i)=>(
    ...
    <rect x="210" y="100" width="28"  height="100" fill="#112233" opacity="0.6"/>
    ...
    <line x1="130" y1="10" x2="130" y2="22" stroke="#C9A84C" strokeWidth="1.5" opacity="0.5"/>
    {[50,62,74,86,98,110,122,134,146,158,170].map((y, i) => (
      <g key={i}>
        <rect x="114" y={y} width="8" height="7" rx="1" fill="#C9A84C" opacity={i % 3 === 0 ? "0.55" : "0.2"} />
        <rect x="126" y={y} width="8" height="7" rx="1" fill="#C9A84C" opacity={i % 2 === 0 ? "0.45" : "0.15"} />
        <rect x="138" y={y} width="8" height="7" rx="1" fill="#C9A84C" opacity={i % 4 === 0 ? "0.5" : "0.2"} />
      </g>
    ))}
    <rect x="50" y="75" width="55" height="125" fill="url(#buildB)" />
    {[82,94,106,118,130,142,154,166,178].map((y, i) => (
      <g key={i}>
        <rect x="56" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 2 === 0 ? "0.4" : "0.15"} />
        <rect x="67" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 3 === 0 ? "0.45" : "0.12"} />
        <rect x="78" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 2 !== 0 ? "0.4" : "0.18"} />
        <rect x="89" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 3 !== 0 ? "0.35" : "0.1"} />
      </g>
    ))}
    <rect x="155" y="82" width="55" height="118" fill="url(#buildC)" />
    {[90,102,114,126,138,150,162,174].map((y, i) => (
      <g key={i}>
        <rect x="161" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 3 === 0 ? "0.4" : "0.15"} />
        <rect x="172" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 2 === 0 ? "0.38" : "0.12"} />
        <rect x="183" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 3 !== 0 ? "0.42" : "0.18"} />
        <rect x="194" y={y} width="7" height="7" rx="1" fill="#C9A84C" opacity={i % 2 !== 0 ? "0.35" : "0.1"} />
      </g>
    ))}
...
const Footer = () => {
  ...
  const socialIcons = [
    { icon: <Mail size={16} />, url: "mailto:info@gitartha.com", label: "Mail" },
    ...
    { icon: <MessageCircle size={16} />, url: "https://wa.me/0000000000", label: "WhatsApp" },
  ];
    ...
    <footer className="footer">
      <div className="footer-main">
        ...
        <div className="footer-left">
          <h2 className="footer-logo">GITARTHA</h2>
          <p className="footer-sub">Finance · Law · Realty · Growth</p>
      ...
      <div className="footer-copyright">
        © {new Date().getFullYear()} Gitartha Realty & Infra. All rights reserved.
      </div>
    </footer>
  );
};
